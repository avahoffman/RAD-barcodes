...
def parse_args():
	...
	parser.add_argument('--i5', help='Number of barcodes of type i5', type=int, required=True)
	parser.add_argument('--i7', help='Number of barcodes of type i7', type=int, required=True)
	parser.add_argument('--i5nn', help='Number of barcodes of type i5nn', type=int, required=True)
	parser.add_argument('--i7nn', help='Number of barcodes of type i7nn', type=int, required=True)
...
def generate_combinations(i5:int, i7:int, i5nn:int, i7nn:int) -> list:
	...
	bc_2 = list(range(1, (i7+1))) # i7 - prefer the most of these because they are less $$
...
def main():
	...
	limit_by_hamming_dist(generate_combinations(i5=args.i5, i7=args.i7, i5nn=args.i5nn, i7nn=args.i7nn))
